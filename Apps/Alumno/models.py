...
class EstudianteSecundaria(Alumno):
    ...
    tipo_de_media = models.CharField(
        max_length=20,
        blank=True,
        help_text="Nombre de la media en la cual está estudiando, si aplica."
    )
    ...
    @classmethod
    def crear_estudiante(cls, _nombre, _apellido, _edad, _sexo, _telefono, _grado, _jornada, _pae, _transporte, media=False, tipo_de_media=""):
        estudiante = cls(
            _nombre=_nombre,
            _apellido=_apellido,
            _edad=_edad,
